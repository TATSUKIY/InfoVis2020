...

{
    ...
    var material_lambertRef = new THREE.ShaderMaterial({
    ...
    var material_phongRef = new THREE.ShaderMaterial({
    ...
    var torus_knot1 = new THREE.Mesh( geometry, material_lambertRef );

    torus_knot1.position.x = -2;

    scene.add( torus_knot1 );

    var torus_knot2 = new THREE.Mesh( geometry, material_phongRef );
